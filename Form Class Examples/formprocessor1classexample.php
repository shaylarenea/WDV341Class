<?php
echo $_POST["first_name"] //display the value of the row with an index of first name 
?>
...
<p>Student First Name: <?php echo $_POST["first_name"]; ?> </p>
<p>Student Last Name: <?php echo $_POST["last_name"]; ?> </p>
</body>
</html>
